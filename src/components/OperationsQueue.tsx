        ...
        return (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-lg font-medium text-white">{service.service}</p>
                <p className="text-sm text-slate-400">{service.team}</p>
              </div>
              <span className={`rounded-full px-2.5 py-1 text-xs font-medium capitalize ${severityStyles[service.severity]}`}>
                {service.severity}
              </span>
            </div>
            ...
            <div className="mt-4 grid gap-3 text-sm text-slate-300 sm:grid-cols-3">
              ...
              <div>
                ...
                <p className="mt-1 font-medium text-white">{service.errorBudget}%</p>
              </div>
              <div>
                <p className="text-slate-500">Incidents</p>
                <p className="mt-1 font-medium text-white">{service.pendingIncidents}</p>
              </div>
            </div>
          </button>
        )
